  ...
  return (
    <div className="flex w-full justify-center flex-wrap  items-center">
      ...
      <div className="flex w-11/12  justify-center  items-center flex-wrap">
        <div className="text-gray-700 body-font   flex-1">
          <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
            <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 text-white items-center flex-wrap text-center">
              <h1
                className="title-font text-xs leading-5 mb-4 font-medium 
      ...
      sm:bg-gradient-to-r sm:from-[#FFB838] sm:via-[#F34F8C] sm:to-[#8236BA]  bg-gradient-to-r from-[#8236BA] via-[#F34F8C] to-[#FFB838]
            ...
            "
              ...
              <p className="mb-8 leading-[40px] text-3xl">
                We design brand, digital experience that engage the right
                customers and As well as right business
              </p>
              <div
                className="flex w-full  sm:w-3/5 justify-between items-center text-white"
                data-aos="fade-right"
              >
                <Progress
                  percent={90}
        ...
        <div className="  flex-wrap   justify-center items-center flex ">
          <div className=" w-[340px] h-[596px] flex flex-wrap items-center justify-center   m-2">
            <div className="flex flex-col justify-center items-center">
              ...
              <div className=">
                ...
                <p className="text-[#A3A3A3] leading-8 font-normal my-4 text-[15px]  text-center tracking-wider mb-2">
          ...
          <div className=" w-[340px] h-[596px]  flex flex-col items-center justify-center   m-2">
            <div className="flex flex-col justify-center items-center">
              <img
                src={a2.src}
                alt=""
