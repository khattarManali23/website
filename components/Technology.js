...
const Technology = () => {
  return (
    <div>
      ...
      <div
        class={`w-full  flex flex-wrap justify-items-center  justify-center gap-y-14 gap-x-6 mt-10 mb-5  `}
      >
        {data.map((item, index) => {
          return (
            <div
              class="w-[19rem] h-[440px]  bg-[#121A21] shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl p-4"
              key={index}
            >
              <a href="#">
