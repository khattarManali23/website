  ...
  return (
    <div>
      ...
      sm:bg-gradient-to-r sm:from-[#FFB838] sm:via-[#F34F8C] sm:to-[#8236BA]  bg-gradient-to-r from-[#8236BA] via-[#F34F8C] to-[#FFB838]"
          ...
          <div class="flex-1  sm:hidden md:hidden lg:flex xl:flex flex-col w-full h-full">
            <Carousel
              showArrows={false}
              showThumbs={false}
              showStatus={false}
            ...
            >
              {career.map((item, index) => {
                return (
                  <div class="text-left h-80    w-full" key={index}>
      ...
      <div class="pt-5  flex-wrap flex items-center flex-col sm:hidden">
        <div class="text-center  p-10">
          <h1
            class="font-bold text-4xl mb-4 text-transparent bg-clip-text sm:py-4 py-2    leading-8   
      sm:bg-gradient-to-r sm:from-[#FFB838] sm:via-[#F34F8C] sm:to-[#8236BA]  bg-gradient-to-r from-[#8236BA] via-[#F34F8C] to-[#FFB838]"
          >
            {" "}
            Careers @Innodeed{" "}
        ...
        <div class="flex-1  flex flex-col w-full h-full">
          ...
          >
            {career.map((item, index) => {
              return (
                <div class="h-[45rem]" key={index}>
                  <div class=" rounded overflow-hidden m-6 shadow-lg">
                    <img class="" src={item.image} alt="Mountain" />
                    <div class="px-6 py-4">
